...
//            }
    ...
    public void testShouldNotBeAbleToLocateASingleElementThatDoesNotExist() {
        driver.get(formPage);
        try {
            driver.findElement(By.xpath("//input[@id='nonExistantButton']"));
    ...
    */
    ...
    public void testShouldBeAbleToUseCustomElementLocators() {
        driver.get(xhtmlTestPage);

        WebElement element = driver.findElement(withName("someForm"));
        assertEquals("someForm", element.getAttribute("name"));
    }

    private By withName(String name) {
